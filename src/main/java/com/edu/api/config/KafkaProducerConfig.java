...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, Object> producerFactory(){
        ...
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class ); // может поставить другой сериализатор
    ...
    public NewTopic topic(){
        return TopicBuilder.name("Education")
                .partitions(1)
                .replicas(1)
